...
class MealViewController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        // Setup the views if editting an existing Meal.
        if let meal = meal {
    ...
    // This method lets you configure a view controller before it's presented, it is called before any segue gets executed
